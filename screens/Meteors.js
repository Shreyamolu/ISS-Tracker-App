        ...
        <ImageBackground source={bg_image} style={styles.backgroundImage}>
          <View style={styles.gifcontainer}>
            ...
            <View>
              ...
              <Text
                style={[styles.cardTitle, { marginTop: 20, marginLeft: 50 }]}> 
                Closest to Earth = 
                {item.close_approach_data[0].close_approach_date_full} 
              </Text>
              <Text
                style={[styles.cardTitle, { marginTop: 5, marginLeft: 50 }]}> 
              ...
              <Text
                style={[styles.cardTitle, { marginTop: 5, marginLeft: 50 }]}> 
                Velocity (Km per Hour) {item.close_approach_data[0].relative_velocity.kilometers_per_hour} 
              </Text>
              <Text
                style={[styles.cardTitle, { marginTop: 5, marginLeft: 50 }]}> 
